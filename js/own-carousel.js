Object.prototype.ownCarousel = function (options) {
    const { // Deafult Object Is Option Not defind This Attribute
        itemPerRow = 4,
        itemWidth = 24, // fill width of each item by CSS Variable
        loop = true,
        responsive = {},
        draggable = true,
        mouseWheel = false,
    ...
    if (loop) {
        ...
        for (let i = 0; i < this.itemPerRow; i++) {
            ...
            cloneNode.children[0].ondragstart = (ev) => ev.preventDefault();
            cloneNode.children[0].ondrag = (ev) => ev.preventDefault();
